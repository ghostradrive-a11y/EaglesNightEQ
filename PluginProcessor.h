...
private:
    ...
    // Five separate filters instead of ProcessorChain to avoid template issues
    Filter leftLowShelf, rightLowShelf;
    Filter leftLowMid, rightLowMid;
    Filter leftNotch, rightNotch;
    Filter leftPresence, rightPresence;

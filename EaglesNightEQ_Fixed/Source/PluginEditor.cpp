...
{
    auto makeFont = [](float size, bool bold = false) -> juce::Font
    {
        juce::FontOptions opts(size);
        if (bold) opts = opts.withStyle(juce::Font::bold);
    ...
    notchLabel.setFont(makeFont(14.0f, true));
    ...
    eaglesLabel.setFont(makeFont(14.0f, true));
    ...
    outputLabel.setFont(makeFont(14.0f, true));
